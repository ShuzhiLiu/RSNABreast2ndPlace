...
visualizer = dict(
    ...
    _scope_='mmcls')
log_level = 'INFO'
load_from = 'https://download.openmmlab.com/mmclassification/v0/convnext/convnext-small_in21k-pre_3rdparty_in1k-384px_20221219-96f0bb87.pth'
resume = False
work_dir = '/kaggle/input/rsna-breast-cancer-detection/work_folder/base_cls_small_pretrain'
